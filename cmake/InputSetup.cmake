...
if(NOT equil)
  ...
  COMMAND ${CMAKE_COMMAND} -Dinput_dir:PATH=${eq_dir} -Dname=${name} -Dinput_type=tests -Darc_json_file:FILEPATH=${arc_json_file} -P ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/download_input.cmake)
...
COMMAND ${CMAKE_COMMAND} -Dinput_dir:PATH=${source_dir} -Dname=${name} -Dinput_type=neutrals -Darc_json_file:FILEPATH=${arc_json_file} -P ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/download_input.cmake)
